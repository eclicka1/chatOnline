	...
	/*******************************************************************************
		...
		RegisterBttn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					User buser;
					buser = new User(0, iNameTxtFld.getText(), "none",
							iAddressTxtFld.getText(), iDateFormat
									.parse(iBirthdayTxtFld.getText()),
							iSignatureTxtFld.getText(), bsex, User.OFFLINE,
							new Date());
		...
		gl_iRegisterPane
				.setHorizontalGroup(gl_iRegisterPane
						...
						.addGroup(
								gl_iRegisterPane
										...
										.addGap(157))
						.addGroup(
								gl_iRegisterPane.createSequentialGroup()
										.addGap(240)
										.addComponent(RegisterToLoginBttn)
										.addGap(6).addComponent(RegisterBttn)
										.addGap(74)));
		gl_iRegisterPane
				.setVerticalGroup(gl_iRegisterPane
						.createParallelGroup(Alignment.LEADING)
						.addGroup(
								gl_iRegisterPane
										.createSequentialGroup()
		...
		LoginBttn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				FrdListView bfrdView = new FrdListView(iWork);
		...
		gl_iLoginPane
				.setHorizontalGroup(gl_iLoginPane
						.createParallelGroup(Alignment.LEADING)
						.addGroup(
								gl_iLoginPane
										.createSequentialGroup()
		...
		gl_iLoginPane
				.setVerticalGroup(gl_iLoginPane
						.createParallelGroup(Alignment.LEADING)
						.addGroup(
								gl_iLoginPane
										.createSequentialGroup()
		...
		gl_iInfoPane
				.setHorizontalGroup(gl_iInfoPane
						.createParallelGroup(Alignment.LEADING)
						.addGroup(
								gl_iInfoPane
										.createSequentialGroup()
						...
						.addGroup(
								Alignment.TRAILING,
								gl_iInfoPane.createSequentialGroup()
										.addContainerGap(264, Short.MAX_VALUE)
										.addComponent(InfoToLoginBttn)
										.addGap(113)));
		gl_iInfoPane.setVerticalGroup(gl_iInfoPane.createParallelGroup(
				Alignment.LEADING)
				.addGroup(
						gl_iInfoPane
								.createSequentialGroup()
								...
								.addGap(76).addComponent(InfoToLoginBttn)
